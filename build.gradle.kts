...
bintray {
  ...
  pkg(delegateClosureOf<BintrayExtension.PackageConfig>{
    ...
    websiteUrl = "https://github.com/programingjd/asynk_http-client"
    issueTrackerUrl = "https://github.com/programingjd/asynk_http-client/issues"
    vcsUrl = "https://github.com/programingjd/asynk_http-client.git"
    githubRepo = "programingjd/asynk_http-client"
    githubReleaseNotesFile = "README.md"
    setLicenses("Apache-2.0")
    setLabels("asynk", "http", "client", "java", "kotlin", "async", "coroutines", "suspend")
          ...
          File("README.md").apply {
            readLines().mapIndexed { i, line ->
              when (i) {
                ...
                9 -> "[Download](https://bintray.com/artifact/download/programingjd/maven/info/jdavid/asynk/http-client/${project.version}/http-client-${project.version}.jar) the latest jar."
                19 -> "  <version>${project.version}</version>"
                32 -> "  compile 'info.jdavid.asynk:http-client:${project.version}'"
                else -> line
              }
            }.joinToString("\n").let {
