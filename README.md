...
[Download](https://bintray.com/artifact/download/programingjd/maven/info/jdavid/asynk/http-client/0.0.0.21/http-client-0.0.0.21.jar) the latest jar.
...
```
dependencies {
  compile 'info.jdavid.asynk:http-client:0.0.0.21'
}
```